 ...
 * V    13-bit immediate operand stored in the opcode
...
#define V0_OP_MASK            ((1 << V0_INS_OP_BITS) - 1)
#define V0_REG_MASK           ((1 << V0_INS_REG_BITS) - 1)
...
/* code-member bits */
#define V0_SGN_BIT    0x8000    // signed operation
...
#define V0_FLG_MASK   0xf000    // code-member flag-bits
/* parm-member bits; low 12 bits are for register IDs (6-bit each) */
#define V0_NO_ADR     0x0000    // register-only operands
#define V0_REG_ADR    0x8000    // base register, e.g. *%r1 or *%pc
#define V0_NDX_ADR    0x4000    // indexed, e.g. $4(%sp) or $128(%pc)
#define V0_ADR_MASK   0xc000    // register-only operands
#define V0_REG2_MASK  0x0fc0    // register operand #2 ID
#define V0_REG1_MASK  0x003f    // register operand #2 ID
