...
#define mjolcanmoveto(ch)       bitset(mjolcmdcanmovetomap, ch)
#define mjolsetmove(ch)         setbit(mjolcmdcanmovetomap, ch)
...
extern uint8_t                  mjolcmdcanmovetomap[256];
...
#define mjolmkcorridor(void)    NULL
#define mjolmkdoor(void)        NULL
#define mjolmkhorizwall(void)   NULL
#define mjolmkvertwall(void)    NULL
